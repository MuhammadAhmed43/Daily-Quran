...
const PANELS = [
  { n: 1, scene: 'a single luminous golden eight-pointed Islamic girih star of intricate interlacing arabesque geometry glowing at the center of a deep indigo night, radiant warm light blooming outward through fine gold filigree, faint scattered stars and soft golden dust around it, ornate sacred and beautiful, deep indigo deepening to warm gold, the opening of a great story, painterly cinematic depth' },
  { n: 2, scene: 'a breathtaking deep-night cosmos in rich indigo and midnight blue, eleven distinct brilliant glowing white-gold stars scattered across the sky together with one radiant glowing sun and one slender crescent moon, all gently inclining toward a single bright point of light at the center, swirling galaxy dust and faint nebula, awe-inspiring and sacred, only deep night sky and cosmos, no ground, no horizon, no land' },
  { n: 3, scene: 'a flawless ornate golden Islamic geometric tile mosaic cracking and fracturing apart, one single bright warm-gold tile still glowing intact while cold grey cracks and dark shadow spread across all the surrounding tiles, tension and envy, deep teal-grey and cold blue tones with one warm gold focal point, dramatic painterly cinematic' },
